...
def manipulate_et_non_conversions():
    ...
    with pd.ExcelWriter(f"{rwanda_path}et_non_conversions/et_non_conversions.xlsx", engine='xlsxwriter') as writer:  
...
def smtp():
    rw_srm_rm = fetch_gsheet_data()["rw_srm_rm"]
    ...
    if not assert_date_modified([et_non_q_file]):
        ...
        for index, row in rw_srm_rm.iterrows():
            ...
            receiver_email = [branchemail,RMemail,"raghav@optica.africa","wairimu@optica.africa","felicity@optica.africa","lenah@optica.africa","john@optica.africa"]
        ...
        # Create a MIMEMultipart class, and set up the From, To, Subject fields
            ...
            NonConversionsfilename = rwanda_path + f'et_non_conversions/branches/{branchcode} Non Conversions Remarks - {report_date}.xlsx'
