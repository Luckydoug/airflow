...
def update_GetEmployeeInformation():
    ...
    query = """truncate voler_staging.source_employee_information;"""
    query = pg_execute(query)
    dfs_list.to_sql('source_employee_information', con = engine, schema='voler_staging', if_exists = 'append', index=False)      
