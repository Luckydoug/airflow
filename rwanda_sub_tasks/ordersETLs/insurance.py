...
pagecount_url = f"https://10.40.16.9:4300/RWANDA_BI/XSJS/BI_API.xsjs?pageType=GetInsuranceSchemeDetails&pageNo=1&FromDate={FromDate}&ToDate={ToDate}&SessionId={SessionId}"
pagecount_payload={}
pagecount_headers = {}
...
def fetch_sap_insurance():
    ...
    for i in range(1, pages+1):
        page = i
        url = f"https://10.40.16.9:4300/RWANDA_BI/XSJS/BI_API.xsjs?pageType=GetInsuranceSchemeDetails&pageNo={page}&FromDate={FromDate}&ToDate={ToDate}&SessionId={SessionId}"
    ...
    if insurance_df.empty:
        ...
        insurance_details.rename (columns = {
            'Code':'id',
            'DocEntry':'doc_entry',
        ...
        #insurance_details.to_sql('source_test_company', con = engine, schema='voler_staging', if_exists = 'append', index=False)
