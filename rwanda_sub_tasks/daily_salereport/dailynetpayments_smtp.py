...
def daily_netsales_email():
    ...
    netsales =pd.read_excel(r"/home/opticabi/Documents/rwanda_reports/Final Summary Net Sales.xlsx",sheet_name = 'daily_monthly')    
    ##Select Columns
    ...
    email_message["Subject"] = f"Rwanda MTD & Daily Net Sales Report for {to_date}"
    email_message.attach(MIMEText(html, "html"))

    # Open the Excel file and attach it to the email
    with open('/home/opticabi/Documents/rwanda_reports/BranchWise Net Sales Report.xlsx', 'rb') as attachment:
