...
def fetch_corrected_forms(engine):
    ...
    *
    FROM voler_staging.source_orderscreenc1 ors
    ...
    *
    ...
    inner join voler_staging.source_orderscreen so
    on co.doc_entry = so.doc_entry
    inner join voler_staging.source_users su 
    on su.user_code::text = so.ods_creator::text
    where co.odsc_date::date between '2023-01-01' and '2024-06-28'
    """
