...
def fetch_sap_invt_transfer_request ():
    ...
    for i in range(1, pages+1):
        page = i
        url = f"https://10.40.16.9:4300/RWANDA_BI/XSJS/BI_API.xsjs?pageType=GetITRDetails&pageNo={page}&FromDate={FromDate}&ToDate={ToDate}&SessionId={SessionId}"
...
#     query = """
#     truncate voler_dw.fact_itr_details;
#     insert into voler_dw.fact_itr_details
#     SELECT 
#         distinct
...
#     FROM voler_mviews.v_fact_itr_details itrd 
#     left join voler_dw.dim_items i on itrd.item_no = i.item_code 
#     left join voler_staging.source_technicians t on itrd.picker_name::text = t.technician_code::text
#     left join voler_mviews.salesorders_with_item_whse whse on itrd.sales_orderno::text = whse.sales_orderno::text 
...
#     query = """
#     truncate voler_mviews.salesorders_with_item_whse;
#     insert into voler_mviews.salesorders_with_item_whse
...
#     FROM voler_mviews.v_salesorders_with_item_whse;
#     """
#     query = pg_execute(query)
...
#     query = """
#     update voler_dw.fact_itr_details itrd
#     set warehouse_code = whse.warehouse_code 
#     from voler_mviews.salesorders_with_item_whse whse 
...
#     query = """
#     truncate voler_mviews.itr_sales_orders;
#     insert into voler_mviews.itr_sales_orders
#     SELECT doc_internal_id, sales_orderno
#     FROM voler_mviews.v_itr_sales_orders;
#     """
#     query = pg_execute(query)
#     return "Updated"
...
#     query = """
#     truncate table voler_mviews.fact_itr;
#     insert into voler_mviews.fact_itr
...
#     query = """
#     update voler_mviews.fact_itr f
#     set branch_code = s.warehouse_code 
#     from voler_mviews.salesorders_with_item_whse s
...
#     query = """
#     truncate voler_mviews.fact_itr_2;
#     insert into voler_mviews.fact_itr_2
...
#     FROM voler_mviews.v_fact_itr_2;
#     """
#     query = pg_execute(query)
#     return "Updated"
...
#     query = """
#     truncate voler_mviews.fact_itr_3;
#     insert into voler_mviews.fact_itr_3
#     SELECT 
#         distinct
...
#     FROM voler_mviews.v_fact_itr_3;
#     """
#     query = pg_execute(query)
#     return "Updated"
...
#     query = """
#     truncate voler_mviews.fact_itr_4;
#     insert into voler_mviews.fact_itr_4
#     SELECT 
#         distinct
...
#         mainstore_cutoff_step, control_first_cut, control_second_cut, control_cutoff_step, packaging_first_cut, 
#         packaging_second_cut, packaging_cutoff_step, replacement_check
#     FROM voler_mviews.fact_itr_3 itr
#     join voler_dw.fact_itr_details itrd on itr.internal_no = itrd.doc_internal_id 
...
#     query = """
#     truncate voler_mviews.branch_picklist_cutoffs;
#     insert into voler_mviews.branch_picklist_cutoffs
#     SELECT warehouse_code, picklist_createdon, picklist_createdtime
#     FROM voler_mviews.v_branch_picklist_cutoffs;
#     """
#     query = pg_execute(query)
#     return "Updated"
...
#     query = """
#     update voler_mviews.fact_itr_4 itr 
...
#     from voler_mviews.fact_itr_4 itr 
#     join voler_mviews.branch_picklist_cutoffs c on itr.warehouse_code = c.warehouse_code 
...
#     join voler_mviews.branch_picklist_cutoffs c on itr.warehouse_code = c.warehouse_code 
#     and salesorder_created_datetime::date = c.picklist_createdon::date
#     join voler_mviews.branch_picklist_cutoffs c1 on itr.warehouse_code = c1.warehouse_code 
...
#     join voler_dw.dim_dates d on itr.salesorder_created_datetime::date = d.pk_date 
...
#     # query = """
#     # update voler_mviews.fact_itr_4
#     # set brs_cutoff_status = 'Within Cutoff'
...
#     # query2 = """
#     # update voler_mviews.fact_itr_4 f
#     # set brs_cutoff_status = 'Within Cutoff'
#     # from voler_dw.dim_dates d
...
#     print("Data Upserted")
#     """
#     query = """truncate voler_mviews.fact_itr3"""
#     query = pg_execute(query)

#     df.to_sql('fact_itr3', con = engine, schema='voler_mviews', if_exists = 'append', index=False)

#     return "Updated"

# def update_itrs_issues():
#     query = """
#     update voler_mviews.fact_itr3 itr 
#     set dropped_status = 1 
#     from voler_dw.dim_itr_issues its 
...
#     update voler_mviews.fact_itr3 itr 
#     set dropped_status = 1 
#     from voler_dw.dim_itr_time_issues itts 
...
# def create_fact_itr():
#     query = """
#     truncate voler_dw.fact_itr;
#     insert into voler_dw.fact_itr
#     SELECT 
...
#     FROM voler_dw.fact_itr itr 
#     join voler_dw.branch_picklist_cutoffs c on itr.warehouse_code = c.warehouse_code 
#     and salesorder_created_datetime::date = c.picklist_createdon::date
#     join voler_dw.branch_picklist_cutoffs c1 on itr.warehouse_code = c1.warehouse_code 
#     and (salesorder_created_datetime+interval '1 day')::date = c1.picklist_createdon::date
...
#     # update voler_dw.fact_itr itr 
#     # set brs_cutoff_status = 'Within Cutoff'
#     # from voler_dw.branch_picklist_cutoffs c 
