...
#     FROM mabawa_staging.source_payment
...
#     payments["mode_of_pay2"] = payments.apply(lambda row: 'Registration' if row['full_doc_type'] == 'Registration Payment' else row["mode_of_pay1"],axis =1)
#     payments['advance_amt'] = pd.to_numeric(payments['advance_amt'])
    
#     payment_summary = payments.pivot_table(index = 'Branch',columns = ['mode_of_pay2'],aggfunc = {'advance_amt':np.sum})
...
#     payment_summary['Total Cash'] = payment_summary['Cash/Mpesa/CC'] + payment_summary['Registration']
#     payment_summary['Total Gross Amount'] = payment_summary['Cash/Mpesa/CC'] +  payment_summary['Registration']
#     payment_summary['Total Cash Net Amount'] = payment_summary['Total Gross Amount'] * (100/116)
#     if 'Insurance' not in payment_summary.columns:
#         payment_summary['Insurance'] = None
       
#     payment_summary['Total Insurance Net Amount'] = payment_summary['Insurance'] * (100/116)
#     payment_summary = payment_summary
#     print(payment_summary)
#     print('yesterdays payments') 

#     import time
#     time.sleep(30)
#     print('lets truncate')
#     query = """truncate mabawa_dw.dim_daily_net_sales_payments;"""
#     query = pg_execute(query)  
#     time.sleep(30)
#     print('truncate finished')    
#     time.sleep(30) 

#     payment_summary.to_sql('dim_daily_net_sales_payments', con=engine, schema='mabawa_dw', if_exists = 'append', index=False) 
#     print('this is finished')

# def mtd_net_payments():
#     paymentsmtd = """
#     SELECT doc_entry, doc_no, user_sign, createdon, createdat,case
#         when length(createdat::text) in (1,2) then null
#         else
...
#     payment_summarymtd = paymentsmtd.pivot_table(index = 'Branch',columns = ['mode_of_pay2'],aggfunc = {'advance_amt':np.sum})
#     print(payment_summarymtd)
...
#     payment_summarymtd['Total Cash'] = payment_summarymtd['Cash/Mpesa/CC'] + payment_summarymtd['Registration']
#     payment_summarymtd['Total Gross Amount'] = payment_summarymtd['Cash/Mpesa/CC'] +  payment_summarymtd['Registration'] + payment_summarymtd['Insurance']
#     payment_summarymtd['Total Cash Net Amount'] = payment_summarymtd['Total Cash'] * (100/116)
#     payment_summarymtd['Total Insurance Net Amount'] = payment_summarymtd['Insurance'] * (100/116)
   
#     import time
#     time.sleep(30)
#     print('lets truncate')
#     query = """truncate mabawa_dw.dim_mtd_net_sales_payments;"""
#     query = pg_execute(query) 
#     print('truncate finished')
#     time.sleep(30)
#     payment_summarymtd.to_sql('dim_mtd_net_sales_payments', con=engine, schema='mabawa_dw', if_exists = 'append', index=False) 
#     print('this is finished')

# def daily_mtd_payments():
#     mtd = """
#         SELECT "Branch", "Cash/Mpesa/CC", "Insurance", "Registration", "Total Cash", "Total Gross Amount", "Total Cash Net Amount", 
#         "Total Insurance Net Amount"
#         FROM mabawa_dw.dim_mtd_net_sales_payments;
#     """
#     mtd = pd.read_sql(mtd,con = conn)

#     mtd = mtd.rename(columns = {"Cash/Mpesa/CC":"MTD_Cash/Mpesa/CC","Insurance":"MTD_Insurance","Registration":"MTD_Registration",
...
#         SELECT "Branch", "Cash/Mpesa/CC", "Insurance", "Registration", "Total Cash", "Total Gross Amount", "Total Cash Net Amount", 
#         "Total Insurance Net Amount"
#         FROM mabawa_dw.dim_daily_net_sales_payments;
#     """
#     daily = pd.read_sql(daily,con = conn)
...
#     # time.sleep(30)
#     print('lets truncate')    
#     query = """truncate mabawa_dw.mtd_daily_net_payments;"""
#     query = pg_execute(query)

#     print('truncate finished')
#     daily_mtd.to_sql('mtd_daily_net_payments', con=engine, schema='mabawa_dw', if_exists = 'append', index=False) 
#     print('this is finished')
# daily_mtd_payments()

# def mtd_daily_net_payments():
#     paymentsmtd_daily = """
#     SELECT doc_entry, doc_no, user_sign, createdon, createdat,case
#     when length(createdat::text) in (1,2) then null
#     else
...
#     paymentsmtd_daily = paymentsmtd_daily.pivot_table(index = ['Create_Date','Branch'],columns = ['mode_of_pay2'],aggfunc = {'advance_amt':np.sum})
#     paymentsmtd_daily = paymentsmtd_daily.droplevel([0],axis=1).reset_index().fillna(0)   
#     paymentsmtd_daily['Total Cash'] = paymentsmtd_daily['Cash/Mpesa/CC'] + paymentsmtd_daily['Registration']
#     paymentsmtd_daily['Total Gross Amount'] = paymentsmtd_daily['Cash/Mpesa/CC'] +  paymentsmtd_daily['Registration'] + paymentsmtd_daily['Insurance']
#     paymentsmtd_daily['Total Cash Net Amount'] = paymentsmtd_daily['Total Cash'] * (100/116)
#     paymentsmtd_daily['Total Insurance Net Amount'] = paymentsmtd_daily['Insurance'] * (100/116)
...
#     netsales = """
#         SELECT "Branch", "MTD_Cash/Mpesa/CC", "MTD_Insurance", "MTD_Registration", "MTD_Total Cash", "MTD_Total Gross Amount", 
#         "MTD_Total Cash Net Amount", "MTD_Total Insurance Net Amount", "Cash/Mpesa/CC", "Insurance", "Registration", "Total Cash", 
#         "Total Gross Amount", "Total Cash Net Amount", "Total Insurance Net Amount"
#         FROM mabawa_dw.mtd_daily_net_payments;
#         """ 
