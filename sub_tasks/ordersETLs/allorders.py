...
logging.basicConfig(filename='all_orders.log', level=logging.INFO,
...
query = """drop table mabawa_staging.landing_orderscreen;"""
...
print('landing_orderscreen inserted')
...
print('source_orderscreen updated')
