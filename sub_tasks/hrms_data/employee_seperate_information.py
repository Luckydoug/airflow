...
def update_GetSeparateEmployeeInformation():
    ...
    query = """truncate mabawa_staging.source_seperate_employee_information;"""
    query = pg_execute(query)
    dfs_list.to_sql('source_seperate_employee_information', con = engine, schema='mabawa_staging', if_exists = 'append', index=False)      
