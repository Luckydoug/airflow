...
pagecount_url = f"https://10.40.16.9:4300/OpticaBI/XSJS/BI_API.xsjs?pageType=GetJEinformation&pageNo=1&SessionId={SessionId}&FromDate={FromDate}&ToDate={ToDate}"
pagecount_payload={}
pagecount_headers = {}
...
def fetch_sap_ojdt():
    ...
    for i in range(1, pages+1):
        page = i
        url = f"https://10.40.16.9:4300/OpticaBI/XSJS/BI_API.xsjs?pageType=GetJEinformation&pageNo={page}&SessionId={SessionId}&FromDate={FromDate}&ToDate={ToDate}"
    ...
    date_cols = ['posting_date','due_date','document_date','date_of_update','recording_date',
                'payment_received_date','create_date']
