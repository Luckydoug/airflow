...
from sub_tasks.paymentsETLs.incentives import (
...
with DAG(
    ...
    fetch_sap_ojdt = PythonOperator(
        task_id="fetch_sap_ojdt", python_callable=fetch_sap_ojdt, provide_context=True
    )
    ...
    clear_cache = PythonOperator(
        task_id="clear_cache", python_callable=clear_cache, provide_context=True
    )
