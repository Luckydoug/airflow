...
with DAG(
    ...
    with TaskGroup("dimensions") as dimensions:
        ...
        with TaskGroup("items") as items:
            ...
            from sub_tasks.dimensionsETLs.items import (
                fetch_sap_items,
                fetch_item_groups,
                create_items_live,
            )
        ...
        with TaskGroup("customers") as customers:
            ...
            from sub_tasks.dimensionsETLs.customers import (
                fetch_sap_customers,
        ...
        with TaskGroup("working_hours") as working_hours:
            ...
            from sub_tasks.dimensionsETLs.whse_hours import (
                fetch_sap_whse_hours,
                create_mviews_whse_hrs,
                create_mviews_branch_hours_array,
                create_dim_branch_hrs,
            )
    ...
    with TaskGroup("goods_receipt") as goods_receipt:
        ...
        from sub_tasks.ordersETLs.goods_receipts import (
            fetch_goods_receipt,
            goods_receipt_live,
        )
    ...
    with TaskGroup("orders") as orders:
        ...
        from sub_tasks.ordersETLs.salesorders import (
            fetch_sap_orders,
        ...
        from sub_tasks.incentives.incentive_factors import (
            refresh_older_than_30days_eyetest_viewed,
        )

        refresh_older_than_30days_eyetest_viewed = PythonOperator(
            task_id="refresh_older_than_30days_eyetest_viewed",
            python_callable=refresh_older_than_30days_eyetest_viewed,
            provide_context=True,
        )
    ...
    with TaskGroup("finance") as finance:
        ...
        with TaskGroup("payments") as payments:
            ...
            from sub_tasks.paymentsETLs.payments import (
                fetch_sap_payments,
                create_customers_mop,
                create_customers_mop_new,
            )
            ...
            (
                [fetch_sap_payments, fetch_sap_web_payments]
                >> create_customers_mop
                >> create_customers_mop_new
            )
