...
from sub_tasks.libraries.utils import return_evn_credentials, uganda_path
...
def calculate_time_difference(row, x, y):
    service_key = pygsheets.authorize(service_file=r"C:\Users\Lucky\Downloads\opticabi-f0b48389fa76.json")
    ...
    normal_business_hours = return_business_hours(normal_day_rule, holiday_dict=)
