...
with DAG(
    ...
    with TaskGroup('attendance_register') as attendance_register:
        ...
        from uganda_sub_tasks.hrms_data.attendance_register import (update_GetAttendanceRegisterData)  
        ...
        from uganda_sub_tasks.hrms_data.employee_information import (update_GetEmployeeInformation)
        ...
        from uganda_sub_tasks.hrms_data.attendance_raw_data import (update_GetAttendanceRawData)  
        ...
        from uganda_sub_tasks.hrms_data.employee_contact_email import (update_GetEmployeeContactEmail)  
        ...
        from uganda_sub_tasks.hrms_data.employee_seperate_information import (update_GetSeparateEmployeeInformation) 
