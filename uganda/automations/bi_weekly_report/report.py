...
def build_overall_trend() -> None:
    create_overall_trend(path=uganda_path, data=conversion_trend())


def build_lowrx_trend() -> None:
    create_lowrx_trend(path=uganda_path, data=lowrx_conversion_trend())
...
# build_overall_trend()
# build_lowrx_trend()
# send_to_branch(path=uganda_path, branch_data=branch_data())
