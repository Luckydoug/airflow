...
def GetAttendanceRegisterData(url, from_date, to_date):     
    ...
    attendance_register['payroll_no_shift_date'] = attendance_register['payroll_no'] + ' ' + attendance_register['shift_date']
...
def update_GetAttendanceRegisterData():
    ...
    dfs_list = dfs_list.set_index('payroll_no_shift_date')    
    print("Data Indexed")
