...
def fetch_sap_orderscreendetailsc1():
    ...
    # print(orderscreenc1[orderscreenc1['odsc_status'] == 'Upload Attachment'])
    query = """truncate mawingu_staging.landing_orderscreenc1;"""
    query = pg_execute(query)

    orderscreenc1.to_sql('landing_orderscreenc1', con = engine, schema='mawingu_staging', if_exists = 'append', index=False)
