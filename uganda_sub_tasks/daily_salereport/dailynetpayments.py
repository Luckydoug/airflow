...
def daily_net_payments():
    ...
    FROM mawingu_staging.source_payment
    ...
    payment_summary['Total Gross Amount'] = payment_summary['Cash/Mpesa/CC']
   ...
   #Save in an excel file
    ...
    with pd.ExcelWriter(r"/home/opticabi/Documents/uganda_reports/Daily Net Sales Report.xlsx", engine='xlsxwriter') as writer:    
...
def daily_mtd_payments():
    ...
    mtd = pd.read_excel(r"/home/opticabi/Documents/uganda_reports/Daily Net Sales Report.xlsx",sheet_name = 'monthly')    
    ...
    daily = pd.read_excel(r"/home/opticabi/Documents/uganda_reports/Daily Net Sales Report.xlsx",sheet_name = 'daily')    
    ...
    print(xlsxwriter.__version__)
    # Create a Pandas Excel writer using XlsxWriter as the engine.
    with pd.ExcelWriter(r"/home/opticabi/Documents/uganda_reports/Final Summary Net Sales.xlsx", engine='xlsxwriter') as writer:    
...
def mtd_daily_net_payments():
    ...
    netsales = """
        ...
        FROM mawingu_dw.mtd_daily_net_payments;
        """ 
    ...
    #Create a Pandas Excel writer using XlsxWriter as the engine.
    with pd.ExcelWriter(r"/home/opticabi/Documents/uganda_reports/Uganda BranchWise Net Sales Report.xlsx", engine='xlsxwriter') as writer:    
