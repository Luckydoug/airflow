...
def daily_netsales_email():
    ...
    email_message["Subject"] = f"Uganda MTD & Daily Net Sales Report for {to_date}"
    email_message.attach(MIMEText(html, "html"))

    # Open the Excel file and attach it to the email
    with open('/home/opticabi/Documents/uganda_reports/BranchWise Net Sales Report.xlsx', 'rb') as attachment:
