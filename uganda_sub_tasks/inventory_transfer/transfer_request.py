...
def fetch_sap_invt_transfer_request ():
    ...
    #itemdetails_df.to_sql('source_itr_details', con = engine, schema='mawingu_staging', if_exists = 'append', index=False)
...
#     query = """
#     truncate mawingu_dw.fact_itr_details;
#     insert into mawingu_dw.fact_itr_details
#     SELECT 
#         distinct
...
#     FROM mawingu_mviews.v_fact_itr_details itrd 
#     left join mawingu_dw.dim_items i on itrd.item_no = i.item_code 
#     left join mawingu_staging.source_technicians t on itrd.picker_name::text = t.technician_code::text
#     left join mawingu_mviews.salesorders_with_item_whse whse on itrd.sales_orderno::text = whse.sales_orderno::text 
#     and itrd.item_no::text = whse.item_no::text
#     """
#     query=pg_execute(query)
#     return "Created"
# create_fact_itr_details ()
# def create_first_mviews_salesorders_with_item_whse():

#     query = """
#     truncate mawingu_mviews.salesorders_with_item_whse;
#     insert into mawingu_mviews.salesorders_with_item_whse
...
#     FROM mawingu_mviews.v_salesorders_with_item_whse;
#     """
#     query = pg_execute(query)

#     return "Complete"
# reate_first_mviews_salesorders_with_item_whse()
# def update_fact_itr_details ():

#     query = """
#     update mawingu_dw.fact_itr_details itrd
#     set warehouse_code = whse.warehouse_code 
#     from mawingu_mviews.salesorders_with_item_whse whse 
...
#     query=pg_execute(query)
#     return "Created"
# update_fact_itr_details ()
# def create_itr_sales_orders():
#     query = """
#     truncate mawingu_mviews.itr_sales_orders;
#     insert into mawingu_mviews.itr_sales_orders
#     SELECT doc_internal_id, sales_orderno
#     FROM mawingu_mviews.v_itr_sales_orders;
#     """
#     query = pg_execute(query)
#     return "Updated"
# create_itr_sales_orders()
# def create_mviews_fact_itr():
#     query = """
#     truncate table mawingu_mviews.fact_itr;
#     insert into mawingu_mviews.fact_itr
...
#     FROM mawingu_mviews.v_fact_itr;
#     """
#     query = pg_execute(query)
#     return "Updated"
# create_mviews_fact_itr()
# def update_null_branches():
#     query = """
#     update mawingu_mviews.fact_itr f
#     set branch_code = s.warehouse_code 
#     from mawingu_mviews.salesorders_with_item_whse s
#     where f.branch_code is null 
#     and f.sales_orderno::text = s.sales_orderno::text
#     """
#     query = pg_execute(query)
#     return "Something"
# update_null_branches()
# def create_mviews_fact_itr_2():
#     query = """
#     truncate mawingu_mviews.fact_itr_2;
#     insert into mawingu_mviews.fact_itr_2
...
#     FROM mawingu_mviews.v_fact_itr_2;
#     """
#     query = pg_execute(query)
#     return "Updated"
...
#     query = """
#     truncate mawingu_mviews.fact_itr_3;
#     insert into mawingu_mviews.fact_itr_3
#     SELECT 
#         distinct
...
#     FROM mawingu_mviews.v_fact_itr_3;
#     """
#     query = pg_execute(query)
#     return "Updated"
...
#     query = """
#     truncate mawingu_mviews.fact_itr_4;
#     insert into mawingu_mviews.fact_itr_4
#     SELECT 
#         distinct
...
#         mainstore_cutoff_step, control_first_cut, control_second_cut, control_cutoff_step, packaging_first_cut, 
#         packaging_second_cut, packaging_cutoff_step, replacement_check
#     FROM mawingu_mviews.fact_itr_3 itr
#     join mawingu_dw.fact_itr_details itrd on itr.internal_no = itrd.doc_internal_id 
...
#     query = """
#     truncate mawingu_mviews.branch_picklist_cutoffs;
#     insert into mawingu_mviews.branch_picklist_cutoffs
#     SELECT warehouse_code, picklist_createdon, picklist_createdtime
#     FROM mawingu_mviews.v_branch_picklist_cutoffs;
#     """
#     query = pg_execute(query)
#     return "Updated"
...
#     query = """
#     update mawingu_mviews.fact_itr_4 itr 
...
#     from mawingu_mviews.fact_itr_4 itr 
#     join mawingu_mviews.branch_picklist_cutoffs c on itr.warehouse_code = c.warehouse_code 
...
#     join mawingu_mviews.branch_picklist_cutoffs c on itr.warehouse_code = c.warehouse_code 
#     and salesorder_created_datetime::date = c.picklist_createdon::date
#     join mawingu_mviews.branch_picklist_cutoffs c1 on itr.warehouse_code = c1.warehouse_code 
...
#     join mawingu_dw.dim_dates d on itr.salesorder_created_datetime::date = d.pk_date 
...
#     # query = """
#     # update mawingu_mviews.fact_itr_4
#     # set brs_cutoff_status = 'Within Cutoff'
...
#     # query2 = """
#     # update mawingu_mviews.fact_itr_4 f
#     # set brs_cutoff_status = 'Within Cutoff'
#     # from mawingu_dw.dim_dates d
...
#         mainstore_cutoff_step, control_first_cut, control_second_cut, control_cutoff_step, packaging_first_cut, 
#         packaging_second_cut, packaging_cutoff_step, replacement_check
#     FROM mawingu_mviews.fact_itr_4
...
#     print("Data Upserted")
#     """
#     query = """truncate mawingu_mviews.fact_itr3"""
#     query = pg_execute(query)

#     df.to_sql('fact_itr3', con = engine, schema='mawingu_mviews', if_exists = 'append', index=False)

#     return "Updated"

# def update_itrs_issues():
#     query = """
#     update mawingu_mviews.fact_itr3 itr 
#     set dropped_status = 1 
#     from mawingu_dw.dim_itr_issues its 
...
#     update mawingu_mviews.fact_itr3 itr 
#     set dropped_status = 1 
#     from mawingu_dw.dim_itr_time_issues itts 
...
# def create_fact_itr():
#     query = """
#     truncate mawingu_dw.fact_itr;
#     insert into mawingu_dw.fact_itr
#     SELECT 
...
#     query = """
#     update mawingu_dw.fact_itr itr 
#         set brs_cutoff_status = 'Within Cutoff'
...
#     FROM mawingu_dw.fact_itr itr 
#     join mawingu_dw.branch_picklist_cutoffs c on itr.warehouse_code = c.warehouse_code 
#     and salesorder_created_datetime::date = c.picklist_createdon::date
#     join mawingu_dw.branch_picklist_cutoffs c1 on itr.warehouse_code = c1.warehouse_code 
#     and (salesorder_created_datetime+interval '1 day')::date = c1.picklist_createdon::date
...
#     # update mawingu_dw.fact_itr itr 
#     # set brs_cutoff_status = 'Within Cutoff'
#     # from mawingu_dw.branch_picklist_cutoffs c 
