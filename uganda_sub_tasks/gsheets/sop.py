...
def fetch_sop_branch_info():
    ...
    query = """truncate mawingu_staging.sop_branch_info;"""
    query = pg_execute(query)

    sh[sh['Country']=='UG'][['branch','branch_code','srm','rm']].to_sql('sop_branch_info', con=engine, schema='mawingu_staging', if_exists = 'append', index=False)
...
def fetch_sop():
    ...
    query = """truncate mawingu_staging.source_sop;"""
    query = pg_execute(query)
